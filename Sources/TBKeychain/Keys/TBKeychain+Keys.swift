...
public extension TBKeychain {
    ...
    func keyPair(publicKey: Data) throws -> KeyPair {
        return try keyPair(publicKey: PublicKey(publicKey))
    }
    
    func keyPair(publicKey: PublicKey) throws -> KeyPair {
        do {
    ...
    func keyPair(applicationLabel: Data? = nil, tag: String? = nil) throws -> KeyPair {
        try KeyPair(attributes: keyAttributes(applicationLabel: applicationLabel, tag: tag))
    }
    
    func keyPairs(applicationLabel: Data? = nil, tag: String? = nil) throws -> [KeyPair] {
    ...
    func keyAttributes(applicationLabel: Data? = nil, tag: String? = nil) throws -> [String: Any] {
    ...
    func keysAttributes(applicationLabel: Data? = nil, tag: String? = nil) throws -> [[String: Any]] {
    ...
    func generateSecureEnclaveKeyPair(tag: String? = nil, label: String? = nil, options: Options? = nil) throws -> KeyPair {
        try generateKeyPair(secureEnclave: true, tag: tag, label: label, options: options)
    }
    
    func generateKeyPair(secureEnclave: Bool, tag: String? = nil, label: String? = nil, options: Options? = nil) throws -> KeyPair {
    ...
    func importPrivateKey(data: Data, tag: String? = nil, label: String? = nil, options: Options? = nil) throws -> KeyPair {
        try validate(tag: tag)
    ...
    func delete(publicKey: PublicKey) throws {
        var query: [String: Any] =  [
            kSecClass as String: kSecClassKey,
    ...
    func encrypt(message: Data, publicKey: Data, algorithm: SecKeyAlgorithm = .eciesEncryptionCofactorVariableIVX963SHA256AESGCM) throws -> Data {
        try encrypt(message: message, publicKey: PublicKey(publicKey), algorithm: algorithm)
    }

    /// Encrypt message with publicKey using provided algorithm.  default = SecKeyAlgorithm.eciesEncryptionCofactorVariableIVX963SHA256AESGCM
    func encrypt(message: Data, publicKey: PublicKey, algorithm: SecKeyAlgorithm = .eciesEncryptionCofactorVariableIVX963SHA256AESGCM) throws -> Data {
    ...
    func decrypt(message: Data, publicKey: Data, algorithm: SecKeyAlgorithm = .eciesEncryptionCofactorVariableIVX963SHA256AESGCM) throws -> Data {
    ...
    func decrypt(message: Data, privateKey: PrivateKey, algorithm: SecKeyAlgorithm = .eciesEncryptionCofactorVariableIVX963SHA256AESGCM) throws -> Data {
        var error: Unmanaged<CFError>?
